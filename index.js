...
function askBot() {
    ...
    $("#m_textbox").click(function () {
        ...
        var user_bot_input_text = $("#m_textbox").val()

        if (user_bot_input_text != "#m_textbox") {
           
            //  add a new div element in the chat window
            $("#m_textbox").append('<div class="user__messages">' + user_bot_input_text + ' </div>')
            
            //Clear the text input box after sending message
            $("#m_textbox").val('');

            let chat_input_data = {
                "#m_textbox": user_bot_input_text
            }
